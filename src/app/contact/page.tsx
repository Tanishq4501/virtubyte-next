              ...
              <AnimatedSection key={index} animation="fadeInUp" delay={index * 0.15}>
                <div className="relative bg-[#E5A2FF0A] rounded-[20px] p-6 border border-[#E5A2FF0A] text-center h-full hover:shadow-[0px_5px_30px_0px_rgba(0,0,0,0.41)] transition-all hover-bob">
                  ...
                  <div className="relative">
                    ...
                    {info.value && (
                      info.href ? (
                        <a href={info.href} className="text-text-light text-[18px] hover:text-primary transition-colors">
                          {info.value}
                        </a>
                      ) : (
                        <p className="text-text-light text-[18px]">{info.value}</p>
                      )
                    )}
                    {info.values && (
                      <div className="space-y-1">
                        {info.values.map((v, i) => (
                          <a key={i} href={v.href} className="block text-text-light text-[16px] hover:text-primary transition-colors">
                            {v.text}
                          </a>
                        ))}
                      </div>
