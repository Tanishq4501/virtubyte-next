...
export const metadata: Metadata = {
  ...
  description:
    "Streamline sales, marketing, and customer operations with customized Salesforce solutions designed to improve productivity, visibility, and revenue growth. Trusted Salesforce consulting firm.",
};
        ...
        <div className="relative max-w-[1280px] mx-auto">
          <AnimatedSection animation="fadeInUp">
            ...
            <p className="text-text-light text-[16px] md:text-[18px] leading-relaxed text-justify max-w-4xl mx-auto mb-4">
              At VirtueByte, we provide strategic and implementation-driven
              Salesforce services, helping organizations transform their CRM
        ...
        <div className="relative max-w-[900px] mx-auto text-center">
          <AnimatedSection animation="fadeInUp">
            ...
            <p className="text-text-light text-[16px] md:text-[18px] leading-relaxed mb-4 max-w-2xl mx-auto">
              Ready to transform your CRM into a scalable revenue-driving
              system backed by expert Salesforce implementation services and
              intelligent Salesforce AI integration?
            </p>
