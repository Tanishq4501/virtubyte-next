...
export const metadata: Metadata = {
  ...
  description:
    "Accelerate innovation, modernize infrastructure, and scale securely with intelligent cloud and DevOps solutions. Cloud migration, DevOps automation, CI/CD, AWS & Azure consulting.",
};
        ...
        <div className="relative max-w-[1280px] mx-auto">
          <AnimatedSection animation="fadeInUp">
            ...
            <p className="text-text-light text-[16px] md:text-[18px] leading-relaxed text-justify max-w-4xl mx-auto mb-4">
              Whether you&apos;re planning cloud migration, optimizing
              infrastructure, or implementing DevOps automation, our cloud
              experts help you build resilient, scalable, and cost-efficient
              cloud ecosystems designed for long-term growth with expert DevOps
              consulting services.
            </p>
            <p className="text-text-light text-[16px] md:text-[18px] leading-relaxed text-justify max-w-4xl mx-auto mb-4">
            ...
            <p className="text-text-light text-[16px] md:text-[18px] leading-relaxed text-justify max-w-4xl mx-auto mb-8">
              ...
              businesses modernize their digital infrastructure efficiently —
        ...
        <div className="relative max-w-[1280px] mx-auto">
          ...
          <AnimatedSection animation="fadeInUp" delay={0.8}>
            <p className="text-primary text-center italic text-[16px] md:text-[18px] mt-8">
              We don&apos;t just migrate systems — we help organizations build
