...
export const metadata: Metadata = {
  ...
  description:
    "Transform raw data into actionable business intelligence with VirtueByte's data science and analytics consulting services. Predictive modeling, BI dashboards, and cloud analytics.",
};
      ...
      <section className="relative py-[50px] px-5 md:px-5 lg:px-0 overflow-hidden">
        ...
        <div className="relative max-w-[1280px] mx-auto">
          <AnimatedSection animation="fadeInUp">
            ...
            <p className="text-text-light text-[16px] md:text-[18px] leading-relaxed text-justify max-w-4xl mx-auto mb-4">
              Whether you&apos;re looking for data analytics consulting,
              business intelligence consulting, predictive modeling, or cloud
              data analytics services, our team helps you unlock measurable
              value from your data ecosystem.
            </p>
