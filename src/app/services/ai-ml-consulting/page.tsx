...
export const metadata: Metadata = {
  ...
  description:
    "Turn data into intelligent action with scalable AI and machine learning solutions designed to improve efficiency, automate workflows, and accelerate decision-making. Trusted AI consulting company.",
};
        ...
        <div className="relative max-w-[1280px] mx-auto">
          <AnimatedSection animation="fadeInUp">
            ...
            <p className="text-text-light text-[16px] md:text-[18px] leading-relaxed text-justify max-w-4xl mx-auto mb-4">
              VirtueByte delivers strategic AI consulting services, machine
              learning development, and enterprise AI integration tailored to
              modern business environments. Today, businesses generate vast
              amounts of data — but without structured AI implementation, that
