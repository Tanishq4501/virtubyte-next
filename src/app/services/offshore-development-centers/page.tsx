...
export const metadata: Metadata = {
  ...
  description:
    "Build a dedicated offshore development team that accelerates innovation. VirtueByte's ODC services provide scalable engineering teams with DevOps, cloud, and agile delivery expertise.",
};
      ...
      <section className="relative py-[50px] px-5 md:px-5 lg:px-0 overflow-hidden">
        ...
        <div className="relative max-w-[1280px] mx-auto">
          <AnimatedSection animation="fadeInUp">
            ...
            <p className="text-text-light text-[16px] md:text-[18px] leading-relaxed text-justify max-w-4xl mx-auto mb-4">
              An Offshore Development Center is a dedicated remote team
              operating as an extension of your in-house engineering department.
              Unlike short-term outsourcing, ODC provides long-term strategic
              alignment, transparency, and scalability. In today&apos;s
              fast-moving digital economy, businesses require agile teams,
              DevOps automation, cloud-native development, and cost-efficient
              engineering models.
            </p>
