...
export default function VirtuElitePage() {
  return (
    <>
      <Breadcrumb items={[{ label: "VirtuElite" }]} />
        ...
        <div className="relative max-w-[1280px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedSection animation="fadeInRight" delay={0.2}>
              <Image
                src="/images/products/virtuelite-laptop.jpg"
                alt="VirtuElite Platform"
                width={600}
                height={400}
        ...
        <div className="relative max-w-[1280px] mx-auto">
          ...
          <AnimatedSection animation="fadeIn">
            <div className="bg-white rounded-[20px] p-6 md:p-10 max-w-4xl mx-auto">
              <Image
                src="/images/products/virtuelite-workflow.png"
                alt="VirtuElite Workflow"
                width={800}
                height={286}
      ...
      <section className="relative py-[50px] px-5 md:px-5 lg:px-0 overflow-hidden">
        ...
        <div className="relative max-w-[1280px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <AnimatedSection animation="fadeInLeft">
              <Image
                src="/images/products/virtuelite-features.png"
                alt="VirtuElite Features"
                width={600}
                height={400}
                className="w-full h-auto rounded-[20px]"
              />
