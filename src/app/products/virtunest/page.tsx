...
export default function VirtuNestPage() {
  ...
  return (
    <>
      <Breadcrumb items={[{ label: "VirtuNest" }]} />
        ...
        <div className="relative max-w-[1280px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <AnimatedSection animation="fadeInRight" delay={0.2}>
              <Image
                src="/images/products/virtunest-hero.jpg"
                alt="VirtuNest Platform"
                width={800}
                height={534}
      ...
      <section className="relative py-[50px] px-5 md:px-5 lg:px-0 bg-[#E5A2FF0A] overflow-hidden">
        ...
        <div className="relative max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <AnimatedSection animation="fadeInLeft">
              <Image
                src="/images/products/virtunest-inspections.jpg"
                alt="Multiple inspections"
                width={700}
                height={467}
                className="w-full h-auto rounded-[20px]"
              />
