...
export default function StrategicSection() {
  return (
    <section className="relative py-[60px] md:py-[80px] px-5 lg:px-0 overflow-hidden">
      ...
      <div className="relative max-w-[1280px] mx-auto">
        <AnimatedSection animation="fadeInUp">
          ...
          <p className="text-text-light text-[16px] md:text-[18px] leading-relaxed text-center max-w-3xl mx-auto mb-12">
            From Salesforce consulting to AI-powered automation and cloud
            migration services, we assist enterprises to stay competitive in
